 ...
 * [Clustering]({filename}/pdf/clustering.pdf) es una introducción al clustering y las principales consideraciones
   a tener en cuenta cuando uno se enfrenta a él: medidas de distancia, outliers, intepretación de resultados,...
 * [Algoritmos]({filename}/pdf/algoritmo.pdf) de clustering: k-means, BRF y CURE. Una muestra de tres algoritmos
